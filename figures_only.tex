...
\begin{figure}[h!]
	\centering
	% \includegraphics[width=\textwidth]{figures/cf-smoothing.pdf}
	\caption{
...
\begin{figure}
	\centering
%	\includegraphics[width=\textwidth]{figures/noise-jitter.pdf}
