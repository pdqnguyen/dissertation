...
\begin{figure}[h]
	\includegraphics[width=\textwidth]{figures/noise-methods/cf-cartoon1.pdf}
	\caption{
...
\begin{figure}[h]
	\includegraphics[width=\textwidth]{figures/noise-methods/cf-cartoon2.pdf}
	\caption{
...
\begin{enumerate}
	\item comma-separated text file consisting of results and \ac{ASDs}
...
\begin{table}\label{table:pemcoupling-format}
