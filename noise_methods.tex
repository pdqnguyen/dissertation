...
A ``boxcar'' smoothing window is used: at each frequency bin, we average the values within the range $(f - \Delta f, f + \Delta f)$, where $\Delta f$ is the smoothing window that itself is frequency-dependent when performing logarithmic smoothing.
