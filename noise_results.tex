...
\begin{figure}[h!]
	...
	\label{fig:noise_ambient-vib}
\end{figure}

Figure~\ref{fig:noise_ambient-vib} shows the ambient contribution of vibrational noise during \ac{O3}, produced by combining the highest coupling factors among accelerometers and microphones measured from an injection campaign at the beginning of \ac{O3}.
...
\subsection{Search for the source of a 48-Hz peak}\label{sec:noise_vib_48hz}
...
Nevertheless, ambient fields are still predicted to produce noise at greater than one-tenth of the design sensitivity in the 10-20\,Hz band (Figure~\ref{fig:noise-ambient-mag}), and may need to be further addressed as we reach design sensitivity in the 10\,Hz region.
