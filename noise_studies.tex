...
There were fewer post-O3 injections due to the premature termination of O3 to the
...
On January 14, a GW trigger S200114f was detected by the \ac{cWB} pipeline~\citep{imbh_o3}.
It was the most significant event detected by an unmodeled search and not accompanied by a trigger in any modeled search pipeline.
Since this meant the possibility of a non-merger detection, a science case study team was put together by the LIGO collaboration to assess the astrophysical nature of the trigger.
